...
cd(home)
titleName = subjINFO;
trimPLI = zeros(64,64,9);
trimPLI(:,:,1) = PLIV(1:64,1:64,FN);
trimPLI(:,:,2) = PLIV(1:64,1:64,BN);
trimPLI(:,:,3) = PLIV(1:64,1:64,FN)-PLIV(1:64,1:64,BN);
trimPLI(:,:,4) = PLI(1:64,1:64,FN);
trimPLI(:,:,5) = PLI(1:64,1:64,BN);
trimPLI(:,:,6) = WPLI(1:64,1:64,FN);
trimPLI(:,:,7) = WPLI(1:64,1:64,BN);
trimPLI(:,:,8) = PLV(1:64,1:64,FN);
trimPLI(:,:,9) = PLV(1:64,1:64,BN);


%%
for k = 1:9
    phittemp = squeeze(trimPLI(:,:,k));
